-- Script simplificado para corrigir configurações do sistema
...
CREATE POLICY "system_config_all_access"
...
SELECT '=== CONFIGURAÇÃO SIMPLIFICADA CRIADA COM SUCESSO ===' as status;
